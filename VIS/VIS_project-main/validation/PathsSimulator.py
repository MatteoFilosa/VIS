...
if __name__ == "__main__":
    ...
    if(userTrace == 0):
        ...
        tmp = str(uuid.uuid4())
        with open('resultExplorations/summary_' + nameVis + '_' + tmp + '.json', 'w') as fp:
            json.dump(finalSummary, fp,  indent=4)

        with open('exploredNodes/summary_' + nameVis + '_' + tmp + '.json', 'w') as file:
            print(exploredNodes)
        ...
        with open('resultExplorations/summaryProblems_' + nameVis + '_' + tmp + '.json', 'w') as fp:
